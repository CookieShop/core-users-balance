...
class OauthUsers
{
    ...
    /**
     * @var \Adteam\Core\Users\Balance\Entity\CoreRoles
     *
     * @ORM\ManyToOne(targetEntity="Adteam\Core\Users\Balance\Entity\CoreRoles")
     * @ORM\JoinColumns({
     ...
     * Set role
     *
     * @param \Adteam\Core\Users\Balance\Entity\CoreRoles $role
     *
     * @return OauthUsers
     */
    public function setRole(\Adteam\Core\Users\Balance\Entity\CoreRoles $role = null)
    {
        $this->role = $role;
     ...
     * Get role
     *
     * @return \Adteam\Core\Users\Balance\Entity\CoreRoles
     */
